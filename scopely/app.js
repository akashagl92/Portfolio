...
const GithubService = {
    ...
    async fetchAllData() {
        ...
        const cached = sessionStorage.getItem('github_data_v12');
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.totalCommits > 0) {
                    ...
                    sessionStorage.setItem('github_data_v12', JSON.stringify(data));
                    return data;
                }
            }
        } catch (e) {
        ...
        try {
            ...
            sessionStorage.setItem('github_data_v12', JSON.stringify(processed));
            return processed;
        } catch (e) {
